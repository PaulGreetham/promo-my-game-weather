  ...
  return (
    <div className="h-[100dvh] grid grid-rows-[1fr_auto_1fr] items-center justify-items-center p-4 sm:p-20">
      ...
      <main className="flex flex-col gap-8 items-center w-full max-w-3xl mx-auto">
        <h1 className="text-5xl font-normal text-white font-[family-name:var(--font-bebas-neue)]">FAQs</h1>
        <div className="w-full px-4">
          <div className="bg-black/20 backdrop-blur-sm rounded-lg p-6">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1" className="border-b border-white/20">
                <AccordionTrigger className="text-xl font-[family-name:var(--font-bebas-neue)] text-white hover:text-white/80">
